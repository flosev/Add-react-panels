...
Mixins.PanelWrapper = {
  ...
  getDefaultProps: function () {
    ...
    var selectedIndex = localStorage.selectedIndex
    } else {var selectedIndex = 0}
    return {
      "icon": false,
      "title": "",
  ...
  setSelectedIndex: function (index, callback) {
    localStorage.selectedIndex = parseInt(index);
    ...
    React.Children.forEach(self.props.children, function(child) {
      var ref = "tabb-" + tabIndex,
        ...
        props = {
          ...
          "onButtonClick":child.props.onButtonClick
        };
      ...
      tabButtons.push({
        key: tabKey, title: props.title, icon: props.icon, onButtonClick: props.onButtonClick, index: tabIndex, ref: ref, showTitle: showTitle,
...
var TabButton = React.createClass({displayName: "TabButton",
  ...
  closeClick: function (event) {console.log('close')
    ...
    return (
        React.createElement("div", {style:sheet.style},
            React.createElement("li", React.__spread({
                ...
                this.listeners), React.createElement("i", {className:"fa fa-times"}))
        )
 ...
 /*   React.createElement("li", React.__spread({
            ...
            this.listeners),
        React.createElement("div", {title: this.props.title,onClick: this.handleClick},
            icon, React.createElement("div", {style: sheet.box.style}, title)
        )
    )*/
    );
